...
\conference{this paper has not been submitted to any other
conferences}
% In the submission example, they had \date{}; but \date{\today} is
% helpful when printing draft copies, to keep track of versions.
%\date{\today}
\date{}
