...
process text on a grand scale.  However, there are some significant
...
#. what does it mean for a program to understand the meaning of a sentence?
#. how can we represent meaning in a computer, and what useful things can we do with these representations?
#. how can we write Python programs that can reason about the meaning of sentences?
...
.. SB: not clear that "case" means subdomain, rather than specific question
...
.. SB: "to the extent that our software already understands SQL" -- why would
