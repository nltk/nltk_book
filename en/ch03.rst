...
it would be helpful to have an index.  We can do that as follows:
...
words (illustrated in Figure stemmer-indexing_).
   ...
   :caption: Indexing a Text Using a Stemmer
    ...
    class IndexedText(object):
        ...
        def __init__(self, stemmer, text):
            ...
            self._idx = nltk.defaultdict(list)
...
.. note:: The code in Figure stemmer-indexing_ uses Python's support for
   *Object Oriented Programming*, which we will describe systematically
   in Chapter REF.
