...
[``\w`` is complement of ``\W``]
    ...
    ']', 'ARTHUR', ':', 'Now', 'stand', 'aside', ',', 'worthy', 'adversary', '.',
    'BLACK', 'KNIGHT', ':', "'Tis", 'but', 'a', 'scratch', '.', 'ARTHUR', ':', 'A',
    'scratch', '?', 'Your', 'arm', "'s", 'off', '!', 'BLACK', 'KNIGHT', ':', 'No',
    ',', 'it', 'isn', "'t."]

[Discuss disjunctive regexp: all word characters or all non-space characters (superset);
left-to-right interpretation of disjunction.]
