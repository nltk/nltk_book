...
`opened the box on the floor`:lx: to be analyzed in two ways,
depending on where the `pp`:gc: is attached.

.. ex::

  .. ex::
    .. tree:: (VP (VP (V opened)(NP (Det the) (Nom (N box)))) (PP (P on )(NP (Det the )(Nom (N floor)))))

  .. ex::
    .. tree:: (VP (V opened)(NP (Det the) (Nom (Nom (N box)) (PP (P on )(NP (Det the )(Nom (N floor)))))))
...
Initialization Rule, followed by successive applications of the Bottom-Up Predict
