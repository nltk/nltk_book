...
use text like ex-ie4_ to answer ex-ie1 directly, we first convert the `unstructured
data`:dt: of natural language sentences into the structured data of
Table db-locations. Then we can do all the usual things that can be
done with structured data. This method of getting meaning from text is
