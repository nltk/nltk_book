...
.. note::
   ...
   Once you've done this, install the data required for the book
   by typing ``import nltk`` and then ``nltk.download()`` at the Python prompt,
   and select the ``book`` collection.
...
we can come up with our own name for a task, e.g. "lexical_diversity", and
...
defines a `function`:dt: called "lexical_diversity".
...
.. table:: brown-types
   ...
   ==================  ===========  ==========  =================
   Genre               Token Count  Type Count  Lexical Diversity
   ==================  ===========  ==========  =================
