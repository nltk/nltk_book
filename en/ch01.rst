...
As we will see throughout this book, it is easy to get your hands on large quantities of text.
Here we want to treat that text as data, analyzing and manipulating it with the help of Python programs.
What can we do with lots of text and some simple programming?
...
``from nltk.book.ch01 import *``.  This loads the text of the book *Moby Dick*
and we can ask the interpreter to give us some information about it, by
typing ``moby``, then typing ``len(moby)``.
