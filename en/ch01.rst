...
(This code assumes that you have already typed
...
be ignored.  We will discuss this syntax more carefully later.  For now
...
.. ex::
   ...
   .. ex:: Les voleurs ont vol\ |eacute| les peintures. *Ils* ont |eacute|\ t\ |eacute| *trouvés* plus tard.  (the thieves)
   .. ex:: Les voleurs ont vol\ |eacute| les peintures. *Elles* ont |eacute|\ t\ |eacute| *trouvées* plus tard.  (the paintings)
