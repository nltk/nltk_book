...
.. note::
   ...
   Once you've done this, install the data required for the book by
...
.. note:: |TRY|
   Try the Eliza chatbot ``nltk.chat.eliza.demo()`` to see an example of
   a primitive dialogue system.  (Remember to ``import nltk`` first.) 
