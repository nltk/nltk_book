...
punctuation symbols.  We discover the size of the vocabulary indirectly, by asking
...
power and flexibility of programming.  We'll make heavy use of
them later.
...
Such lines have the form: *variable = expression*.  The variable
can be anything you like, e.g. ``my_sent``, ``sentence``, ``xyzzy``.
...
..
    >>> mytext = sent1 + sent2 + sent3 + sent4 + sent5
    >>> sorted(set(mytext))
    ['-', '.', ':', 'Call', 'Citizens', 'Dashwood', 'Fellow', 'God',
    'House', 'I', 'In', 'Ishmael', 'JOIN', 'PMing', 'Representatives',
    'Senate', 'Sussex', 'The', 'a', 'and', 'been', 'beginning', 'created',
    'earth', 'family', 'had', 'have', 'heaven', 'in', 'lol', 'long',
    'me', 'of', 'people', 'problem', 'settled', 'the', 'to', 'with']
...
.. all words that appear next to word "x"?
...
same ones on either end of the string.  (When using single quotation marks,
you must use the close quote character at the start and the end.)
...
#. |talk| Discuss the steps you would go through to find the ten
