...
Counting Other Things than Words (NOTES)
----------------------------------------
...
Letter frequencies -- what are the most frequent letters in English?

    >>> fdist = FreqDist(letter for word in text1 for letter in word)
...
Need for normalization and filtering:
...
We'll return to normalization chapter 2...
