...
we will repeat any important points in later chapters.
...
explain what is going on in each one.    
    ...
    ['Stock-index', 'index-arbitrage', 'index-fund', 'index-options', 'index-related', ...]
    >>> sorted(wd for wd in set(text3) if wd.istitle() and len(wd) > 10)
    ['Abelmizraim', 'Allonbachuth', 'Beerlahairoi', 'Canaanitish', 'Chedorlaomer', ...]
