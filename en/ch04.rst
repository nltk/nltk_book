...
for tallying words shown in Figure fig-tally_, Chapter chap-introduction_.
...
values, in order to show the words in decreasing order of frequency.  We use the ``sorted()``
