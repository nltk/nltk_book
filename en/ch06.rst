...
seen so far.  Let's find the longest word in a text.  We'll need a variable to hold
...
A better solution uses two list comprehensions as shown below.
We sacrifice some efficiency by have two passes through the data,
...
through the data is very fast.  We also need to balance our concerns with
Python's efficiency versus the programmer's efficiency in developing and
