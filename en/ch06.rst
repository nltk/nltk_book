...
the structure of the programming language.  We begin by going right
back to the basics.
...
worth its own section.  However, there are some surprising subtleties and
...
This behaves exactly as expect.  When we write ``bar = foo``,
...
[Implications of the above understanding of object references for
testing equality.]
...
----------------------------------------------------------
Functions |mdash| The Foundation of Structured Programming
----------------------------------------------------------
