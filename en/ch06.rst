...
better approach, known as "duck typing" in Section [XREF].)
...
In this section we will explore two of these, PyLab and NetworkX.
The PyLab package supports sophisticated
plotting functions with a MATLAB-style interface, and is available from
``http://matplotlib.sourceforge.net/``.  The NetworkX package is for
