...
----------------------------------
Working with Low-Density Languages
----------------------------------
...
Language endangerment and the challenge for computational linguistics

[MORE]

* lack of tools: need to develop them; adapt them from related languages
* lack of data for applying some of the statistical techniques described here
* need to clean the data
* priorities: text collection; lexicon; bilingual text; morph analyzer
