...
* which corpora have ``sents()``
* example program to find shortest/longest sentence in a corpus
...
The above code illustrates an important programming idiom for working with dictionaries,
and we'll give a schematic version here::
...
Defining One Dictionary From Another
------------------------------------
