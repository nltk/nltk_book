...
.. TODO: explain str.find, used in opening section
...
90% of the texts in Project Gutenberg are in English.  However, it
...
Its possible to use a web browser to save a page as text to a local
file, then access this as described in Section sec-reading-local-files_.
However, if we're going to do this a lot, its easiest to get Python
...
content and trim the text, and initialize a text as before.
...
to the local drive, and access it as described in Section sec-reading-local-files_.
...
.. _sec-reading-local-files:

Reading Local Files
-------------------

* open
* finding the file, pathnames
