...
Section sec-conditional-frequency-distributions_.
...
we often want to maintain separate wordcounts for each category.
...
[TABLE SHOWING ConditionalFreqDist API]

Examples 

Example: Generating Random Text with Bigrams
--------------------------------------------

In Figure random_, we use a conditional frequency distribution
to create a bigram table.  For each word we have a ``FreqDist``
over the following words.  The function ``generate_model()``
...
as part of speech and sense definitions.

Lexical resources are secondary to texts, and are usually created enriched with the help
...
of these are simple lexical resources.  A concordance tool 
...
.. pylisting:: dictionary
   :caption: Incrementally Updating a Dictionary, and Sorting by Value
    ...
    [(',', 1962), ('.', 1235), ("'", 637), ('the', 531), (':', 477), ('and', 376), ('I', 333),
    ('of', 315), ('to', 311), ('?', 241), ('d', 224), ('a', 214), ('you', 184), ('in', 173),
    ('my', 170), ('And', 170), ('is', 166), ('that', 158), ('not', 155), ('it', 138), ...]
    >>> [w for w,c in sorted(counts.items(), key=itemgetter(1), reverse=True)]
    [',', '.', "'", 'the', ':', 'and', 'I', 'of', 'to', '?', 'd', 'a', 'you', 'in', 'my', 'And',
    'is', 'that', 'not', 'it', 'Macb', 'with', 's', 'his', 'be', 'The', 'haue', 'me', 'your',
    'our', '-', 'him', 'for', 'That', 'Enter', 'this', 'he', 'What', 'To', 'so', 'all', 'are', ...]
...
Here's another example, where we index the words according to their last two letters:
    ...
    >>> last_letters['zy']
    ['breezy', 'buzzy', 'cozy', 'crazy', 'dizzy', 'frenzy', 'fuzzy', 'hazy', 'jazzy', 'lazy', 'Lizzy', 'snazzy']
...
Can you think of the animal and verb sense of each word?
    ...
    ['baby', 'baby', 'beetle', 'bird', 'bug', 'bug', 'bulldog', 'clam', 'cock',
    'cockle', 'cub', 'dam', 'dog', 'escallop', 'fawn', 'fish', 'foal', 'frog',
    'game', 'grouse', 'grub', 'head', 'hog', 'hound', 'kit', 'kitten', 'lamb',
    'leech', 'mate', 'orphan', 'oyster', 'parrot', 'pet', 'pooch', 'prey', 'pup',
    'quail', 'quarry', 'queen', 'queen', 'scallop', 'scollop', 'sire', 'slug',
    'snail', 'spat', 'sponge', 'steer', 'stray', 'stud', 'stunt', 'toy',
    'whelp', 'worm']
