...
codes, i.e. distinct labels for each contrastive sound.  The digits represent
primary stress (``1``), secondary stress (``2``) and unstressed (``0``).
Observe that `fire`:lx: has two pronunciations:
...
syllable counting task -- metrical
