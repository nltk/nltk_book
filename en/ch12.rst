...
Despite its many files, the TIMIT corpus only contains two fundamental data types,
...
For example, the Brown Corpus contains 500 text files, but we use a table to relate
the files to 15 different genres.  At the other end of the spectrum, WordNet
contains 117,659 synset records, but incorporates many example sentences to illustrate
word usages.  TIMIT is an interesting mid-point on this spectrum, containing substantial
...
[Structure of each play: act, scene, speech, line]

    >>> merchant[7][1][54][1].text
    'The quality of mercy is not strain'd,'




Case Study: Using XML API for working with Toolbox Data
-------------------------------------------------------
