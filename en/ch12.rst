...
.. ex::
   ...
   .. _ex-predlog52:
   .. ex:: `dog(x)`:mathit:  |wedge| `disappeary(x)`:mathit: 
...
|nopar| In admiregraph_, an arrow between two individuals `x`:math: and
...
`barks`:lx: respectively. This grammar can be parsed using the chart
