...
and contributions in these and other areas are welcome.
...
Python and its other libraries, and interfaces to third-party
...
For more information about current work on using FUF-based approach to NLG,
visit 

Linguistic Fieldwork
--------------------

* support for various fieldwork data formats including interlinear text
...
and have to explain that this field concerns the
...
or more broadly, about how to write programs to manipulate text
for arbitrary choices of language.
