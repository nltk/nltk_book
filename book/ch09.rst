...
.. TODO:
   ...
   * deal with callouts in discussion of parse trace for KLC
   * make _ex-gapparse consistent with actual parse
...
.. pylisting:: code-featurecharttrace
   :caption: Trace of Feature based Chart Parser
    ...
    Completer |. [-> .| [1:2] VP[NUM=?n, TENSE=?t] -> TV[NUM=?n, TENSE=?t] * NP[] {?n: 'sg', ?t: 'pres'}  # [_binding1]
    Scanner   |. . [-]| [2:3] 'children'
    Scanner   |. . [-]| [2:3] N[NUM='pl'] -> 'children' *
    Completer |. . [-]| [2:3] NP[NUM='pl'] -> N[NUM='pl'] *
    Completer |. [---]| [1:3] VP[NUM='sg', TENSE='pres'] -> TV[NUM='sg', TENSE='pres'] NP[] *  # [_binding2]
...
upwards" from lexical entries, and variable values are then bound to
those values binding1_. As the parser assembles information about the
nodes of the tree it is building, the bindings of variables are used
to instantiate values in these nodes binding2_.
