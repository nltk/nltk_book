...
The following code considers other words as well:
it converts words to lowercase using ``w.lower()`` lowercase-startswith_,
...
please consult the Corpus HOWTO at |NLTK-HOWTO-URL|.
   ...
   (because the published table will be immediately out of date, so its necessarily
   a selection; there's incidental corpora not worth listing here.) 
...
.. table:: tab-corpora
   ...
   CoNLL 2007 Dep Treebanks (selections)  CoNLL                  150k words, dependency parsed (Basque, Catalan)
...
.. doctest-ignore::
    ...
    ['The', '55-year-old', 'Mr.', 'Noriega', 'is', "n't", 'as', 'smooth', 'as', 'the', 'shah'
    'of', 'Iran', ',', 'as', 'well-born', 'as', 'Nicaragua', "'s", 'Anastasio', 'Somoza', ',',
    'as', 'imperial', 'as', 'Ferdinand', 'Marcos', 'of', 'the', 'Philippines', 'or', 'as'
    'bloody', 'as', 'Haiti', "'s", 'Baby', Doc', 'Duvalier', '.']   
...
.. XXX I wonder about dropping this -- ie just wait till ch11?
   (maybe, but its currently used in ch03)
...
Consider the following similarity scores, relating the words `minke`:lx:,
`tortoise`:lx:, and `novel`:lx: to the word `orca`:lx:.
Although the numbers won't mean much, they obviously decrease as
we move away from the semantic space of whales to sea creatures and
then to inanimate objects.
