...
brackets and just write: ``set(w.lower() for w in t)``.  (See the discussion
of "generator expressions" in sec-sequences_ for more about this.)
Our little program makes use of this simpler syntax:
