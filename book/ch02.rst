...
.. note::
   ...
   defined this way.  Instead you have to use the following statement:
...
into two sets, called "training" and "test".  This split is for
...
The condition is either of words `america`:lx: or `citizen`:lx: america-citizen_,
...
The plot in fig-word-len-dist_ was based on a conditional frequency distribution,
reproduced below, where the condition is the name of the language
...
Although definitions help humans understand the intended meaning of a synset,
