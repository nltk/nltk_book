...
those we saw for example ex-elephant_:
...
trees.  Example ex-recnominals_ involves nested nominal phrases,
...
Let's set our input to be the sentence in ex-marx-elephant_.
