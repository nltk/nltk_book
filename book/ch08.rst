...
.. XXX what is a "formal device"?  (changed to "formal notation")
...
Here, a "language" is considered to be nothing more than an
...
complements. By contrast with ex-subcat1_, the word sequences
in ex-subcat2_ are ill-formed:
...
.. XXX grammar as a string -- different concept of string
   ...
   (Fixed now that string is not used in a novel sense any more.)
