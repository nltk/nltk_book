...
:New to Programming?:  The book is suitable for readers with no prior
    knowledge of programming, who are not afraid to tackle many new
    concepts and develop new computing skills.
    The book is full of examples that you can simply copy and
    try for yourself, together with hundreds of graded exercises.
    If you decide you need a more general introduction to Python, see the
    list of Python books at ``http://docs.python.org/``, many of them
    available online.
...
:Already dreaming in Python?:  Skim the Python examples
    ...
    material that starts in Chapter chap-introduction_.
...
**Python:**
The material presented in this book assume that you are using Python version 2.4 or 2.5.
...
**Matplotlib:**
This is a 2D plotting library that supports an extensive range of data visualizations,
...
nodes and edges.  For visualizing networks, also install **Graphviz**.
These are useful for studying semantic networks.
...
of more fundamental concepts such as strings, loops, files, and so forth.
Thus we cover the same ground as more conventional approaches,
...
.. table:: tab-course-plans
   ...
   4  Writing Structured Programs                   2-4                  0
