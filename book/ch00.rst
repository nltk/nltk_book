...
:Extensibility: to provide a structure into which new software
    modules can be easily accommodated.
...
and Python communities, and for customizing O'Reilly's production tools
...
for their patience and support over the years that we worked on this book.
We hope that our children |mdash| Andrew, Alison, Kirsten, Leonie and Maaike |mdash|
catch our love of language and computation from these pages. 
