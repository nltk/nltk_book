...
:Extensibility: to provide a structure into which new software
    ...
    implementations and competing approaches to the same task; and
...
or implementations in lower-level programming languages like C or C++.
...
The book contains hundreds of exercises which can be used
...
This book is a credit to the many developers who have contributed to
|NLTK|. Although they are listed individually at
|NLTK-URL|, we would like to thank them collectively for their
valuable efforts.
...
We thank Julie Steele, Abby Fox, and the rest of the O'Reilly team, for
organizing comprehensive reviews of our drafts from people across the |NLP|
and Python communities, and for cheerfully customizing O'Reilly's production tools
to accommodate our needs and deliver stylish pages from arcane markup.
