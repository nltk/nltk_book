...
example, the features returned by the feature extractor shown in Example
...
in Example code-classification-based-segmenter_ shows how this can be done.
...
contains those patterns.  For example, as we saw in Table tab-absolutely_,
