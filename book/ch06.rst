...
Detecting patterns is a central part of |NLP|.  Words ending in
...
maximum entropy classifiers.  We will gloss over the mathematical and
...
framework used by supervised classification is shown in Figure
...
of these words is present or not in a given document:

    >>> stopwords = nltk.corpus.stopwords.words('english')
    >>> def document_features(document):
    ...     document_words = set(document)    # [document-set_]
    ...     features = {}
...
.. note:: 
    ...
    checking whether a word occurs in a list.
...
has.  Now that we've defined our feature extractor, we can use it to
train a new "decision tree" classifier (discussed in more
detail in sec-decision-trees_):
...
find the most likely class label for one of the related inputs; and
...
described in chap-tag_, is a good example of this strategy.
