...
.. XXX "naive Bayes" or "Naive Bayes"? FWIW, J&M only use the former
...
In this case, our test set will be *very* similar to our test
...
test set from documents that are less strongly related to those
in the training set:
...
.. XXX generative -> conditional in next sentence?
