...
is about 10% lower than the accuracy of a classifier that only
...
Given that restriction, it is possible to use
dynamic programming (sec-algorithm-design_)
...
.. note::
   ...
   models, the term "features" is often refers to
   joint-features; the term `contexts`:dt: is refers to what
...
.. XXX generative -> conditional in last sentence?
...
* When training a supervised classifier, you should split your corpus
  into three data sets: a training set for building the
