...
the theory of machine learning, see [Hastie200]_.  Excellent books on
using machine learning techniques for |NLP| include [Abney2008]_,
[Daelemans2005]_, [Feldman2007]_, [Segaran2007]_, [Weiss2004]_.  For
more on the use of smoothing techniques for language problems, see
[Manning1999FSN]_.  For more on sequence modelling, and espcecially
...
of numerically intensive algorithms in Python, se [Kiusalaas2005]_.
...
techniques to |NLP| problems is driven by governmet-sponsored
...
competitions, and the AQUAINT competitions.  Consult |NLTK-URL| for a
