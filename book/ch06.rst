...
important that we use a separate dev-test set for error analysis,
...
example, names ending in "el" appear to be predominantly female, while
...
does not start to reflect idiosyncracies in the dev-test set.
...
Recent textbooks that cover text classification [Manning2008IR]_, [Croft2009]_.
