...
form, such as the little example in Table db-locations_, then
...
about ex-ie4_ to return the answers in Table db-answers_?  This is
obviously a much harder task. Unlike Table db-locations_, ex-ie4_
...
Table db-locations_. Then we reap the benefits of powerful query
...
can be manipulated directly.  An example is shown in Figure chunk-treerep_.
...
remains.  These three possibilities are illustrated in Table chinking-example_.

.. table:: chinking-example
...
We are grateful to Nicola Stokes for providing the example in Figure fig-locations_.
