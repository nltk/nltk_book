...
resulting chunk structure is returned.  Example chunker1_ shows a
...
Example multistage-chunker_.  It has a stage for each of the chunk types.
...
stage of processing.
In Example chunker2_, two chunk patterns are applied to the input
