...
A conversion function ``chunk.util.conllstr2tree()`` builds a tree
...
.. doctest-ignore::
    ...
    ... . . O
    ... '''
    >>> nltk.chunk.util.conllstr2tree(text, chunk_types=['NP']).draw()
...
sentences; and use the ``nltk.chunk.util.conlltags2tree()`` function to
...
value of parameter ``relsym`` relsym_. 
    ...
    ...         print(nltk.sem.relextract.show_clause(r, relsym="VAN")) # [_relsym]
