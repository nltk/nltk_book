...
The Python website also provides extensive documentation about the language,
including introductory tutorials, and links to other resources, including other
books on Python for a general (non NLP) audience.
