...
Python code to produce the contents of Table tab-absolutely_; mention
Yahoo Python API and xref to discussion of this in Chapter chap-data_.]
...
and is illustrated in Figure fig-unicode_.
...
string like ``'latin-1'``, ``'big5'`` or ``'utf-8'`` (see Figure fig-polish-utf8_).
...
The meta-characters we have seen are summarized in Table tab-regexp-meta-characters1_. 
...
words (illustrated in Example code-stemmer-indexing_, which uses *object oriented*
