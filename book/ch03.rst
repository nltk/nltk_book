...
Here are some more examples, illustrating the use of some new symbols:
``\``, ``{}``, ``()``, and ``|``:
...
.. XXX bad line breaks above
   (pending fix for issue 324)
...
Discovering hypernyms in text [Hearst1992HYP]_.
