...
we used for lists (see fig-string-slicing).
...
For information about proc
Normalizing non-standard words [Sproat2001NOR]_
...
e.g. `part of speech`:lx: [BaldwinKim2009]_.
