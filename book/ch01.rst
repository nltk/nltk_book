...
items being counted, the numbers 1 through 20, because there are only twenty
...
words of length 3 account for roughly 50,000 (or 20%) of the words of the
...
* Indurkya, Nitin and Fred Damerau (eds, 2009) *Handbook of Natural Language Processing*
  (Second Edition) Chapman & Hall/CRC. 2009.  [IndurkyaDamerau2009]_ [Dale00handbook]_
