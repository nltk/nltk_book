...
correct results for ex-twitter-sa_.
...
books, then one cannot conclude that he/she is author of eighteen
books.
...
Sentiment analysis is a broad term for a range of techniques that try
to identify the subjective views expressed in texts. Many
organisations care deeply about public opinion |mdash| whether these
concern commercial products, creative works, or political parties and
policies |mdash| and have consequently turned to sentiment analysis as
a way of gleaning valuable insights from voluminous bodies of online
text. This in turn has stimulated much activity in the area, ranging
from academic research to commercial applications and
industry-focussed conferences.
...
.. ex::
   .. ex:: Good stuff from Clegg. Clear, passionate & honest about the difficulties of govt but also the difference @LibDems have made.
   .. ex:: Hmm. Ed Miliband being against SNP is a bad move I think. It'll cost him n it is a dumb choice.
   .. ex:: Why is Ed Milliband trending when him name is Ed Miliband?
