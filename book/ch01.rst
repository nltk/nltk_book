...
.. note::
   ...
   detailed instructions. Note that NLTK 3.0 works for Python 2.6 and
...
question, then inserting the relevant word in parentheses:
    ...
    part curious lamentable maddens tyrannical fearless loving domineering
    pitiable careful lazy few vexatious mouldy exasperate uncommon
    christian contemptible singular mean
    >>> text2.similar("monstrous")
    very so exceedingly heartily amazingly remarkably extremely vast a as
    great good sweet
    >>>
