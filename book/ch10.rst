...
2. generalized quantfiers such as `most`:lx:;

3. intensional constructions involving, for example, verbs like `may`:lx: and
  `believe`:lx:;

While (1) can be dealt with using |FOL|, (2) and (3) require different logics. These
issues are covered by many of the references in the readings below.
...
intensional logic, see [Gamut1991IL]_ and [Gamut1991ILG]_. [KampReyle1993]_ provides
