...
be parsed into logical expressions as discussed earlier. (We say more about theorem
proving  in sec-fol_.)
...
``load_earley()`` that ``sem`` values in feature structures are to be
...
result:
    ...
    d1: ['s0-r1', 's1-r0'] : ([z8,z12],[boy(z8), (([x],[dog(x)]) -> 
    ([],[chases(x,z8)])), (z12 = z8), runs(z12)])
...
``filter=True``.
    ...
    d1: ['s0-r1', 's1-r0'] : ([z14,z17],[boy(z14), (([x],[dog(x)]) ->
    ([],[chases(x,z14)])), (z17 = z14), runs(z17)])
