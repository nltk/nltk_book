...
Is our understanding of Python's semantics at fault
assignment

indentation, operator precedence


* adding diagnostic print statements, checking your assumptions
* isolate the problem: get it down to a few lines; test it with a small instance (e.g. trivial input file)
* disciplined approach to setting out, variable names etc
* don't just randomly change things in the hope that something will work
* sometimes the program is giving the correct result; you just didn't understand what you were asking it to do
* hunting with divide-and-conquer
* defensive programming: adding asserts etc
* showing code to someone else...
* reading the stack-trace

Regression tests -- doctest framework
